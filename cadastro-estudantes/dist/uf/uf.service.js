...
exports.UfService = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const uf_entity_1 = require("./uf.entity");
let UfService = class UfService {
    ufRepository;
    constructor(ufRepository) {
        this.ufRepository = ufRepository;
    }
    async create(createUfDto) {
...
exports.UfService = UfService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(uf_entity_1.Uf)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], UfService);
//# sourceMappingURL=uf.service.js.map